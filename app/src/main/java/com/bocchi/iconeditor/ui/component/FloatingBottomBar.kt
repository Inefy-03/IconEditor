...
import com.bocchi.iconeditor.liquid.InnerShadow
import com.bocchi.iconeditor.liquid.innerShadow
import com.bocchi.iconeditor.liquid.lens
import com.bocchi.iconeditor.liquid.rememberCombinedBackdrop
import com.bocchi.iconeditor.liquid.vibrancy
import com.bocchi.iconeditor.ui.interaction.DampedDragAnimation
import com.bocchi.iconeditor.ui.interaction.InteractiveHighlight
...
fun FloatingBottomBar(
    ...
    val isInDark = isIconEditorDark()
    val pillShape = remember { CircleShape }
    val isLiquidGlassMode = mode == FloatingBottomBarMode.LiquidGlass
    val isBlurMode = mode == FloatingBottomBarMode.Blur
    val containerColor = if (isLiquidGlassMode) colors.containerColor.copy(0.4f) else colors.containerColor
    ...
    val interactiveHighlight = if (isLiquidGlassMode && Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
